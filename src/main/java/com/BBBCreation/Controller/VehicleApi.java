...
//	}
	...
	@PostMapping(value="/addDriverDetails/{vehicleId}")
	public ResponseEntity<String> addDriverDetails(@ModelAttribute  DriverDTO driverDTO,@PathVariable String vehicleId ) throws VehicleMangementException, IOException{
...
//	public static byte[] compressBytes(byte[] multipartFile) throws IOException {
